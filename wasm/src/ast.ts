...
const sumz = (n: N[]) => n.reduce((sum, ni)=>sum+ni.z, 0);
...
export class type_atom extends u8_atom<int7> {
  readonly b :uint8
...
export class instr_atom extends u8_atom<OpCode> {
  readonly r :AnyResult
  constructor(v: OpCode, r :AnyResult) { super(T.instr, v); this.r = r }
}

export class instr_cell implements N {
  readonly t   :TypeTag
  readonly z   :uint32
  readonly v   :OpCode
  readonly r   :AnyResult
...
export class instr_pre1 extends instr_cell {
  readonly pre: N
...
export class instr_imm1 extends instr_cell {
  readonly imm :N
...
export class instr_pre extends instr_cell {
  readonly pre :N[]
  constructor(op: OpCode, r :AnyResult, pre :N[]) {
...
export class instr_imm1_post extends instr_cell {
  readonly imm :N
  readonly post :N[]
...
export class instr_pre_imm extends instr_cell {
  readonly pre :N[]
  readonly imm :N[]
...
export class instr_pre_imm_post extends instr_cell {
  readonly pre  :N[]
  readonly imm  :N[]
  readonly post :N[]
